...
//   「分からない」と出したままにしてある**＝KP-6でそれも見張る。
{
  ...
  eq('KP-8 ミニトマト2個は32円（トマト1個60円とは別の行）', kpYen('ミニトマト', '2', '個'), 32)
  ...
  eq('KP-8 米油に目安価格がある（大さじ1で9円。旧: 前方一致で「米 60円/1合」に当たっていた）', kpYen('米油', '1', '大さじ'), 9)
  // 2026-08-26 便LF: 粉チーズを並のグレードで測り直して620→475円/80gにしたので78→59円
  eq('KP-8 粉チーズ10gは59円（便LFの前は78円）', kpYen('粉チーズ', '10', 'g'), 59)
...
// scripts/test-nutrition.mjs の「3. スナップショット照合」のコメントにも残してある。
{
  ...
  ], ['ピザ用チーズ 430円/200g', 'ピザ用チーズ 430円/200g', 'ピザ用チーズ 430円/200g'])
  eq('LB-2 「粉チーズ」の価格行は別のまま（振りかける粉で別物。便LFで620→475円/80g）', lbPrice('粉チーズ'), '粉チーズ 475円/80g')
