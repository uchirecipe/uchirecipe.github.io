...
export const NUTRITION_DATA: NutritionData = {
  ...
  "foods": [
    ...
    },
    {
      ...
      "note": "「味噌」とだけ書かれた場合は淡色辛みそで代表。2026-08-25 便KW: 八訂の分類名そのものである「米みそ」を別名に足した。これが無いあいだ、価格側で「米みそ」が前方一致で「米 60円/1合」(生の米の値段)に当たっていた(priceEstimate.ts の isSameNutritionFood は、材料名が成分表に解決できないときは前方一致を通す)"
    },
    {
      "id": "17044",
      "label": "白味噌",
