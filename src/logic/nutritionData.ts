...
export const NUTRITION_DATA: NutritionData = {
  ...
  "foods": [
    ...
    },
    {
      ...
      "note": "2026-08-25 便KY: プロセスチーズ(313kcal・食塩2.8g/100g)に流れていたが、粉チーズは八訂13038「ナチュラルチーズ パルメザン」で445kcal・食塩3.8g/100g。大さじ6g/小さじ2gは一般的な調理換算表の粉チーズの目安量（docs/48が他の調味料で採ったのと同じ流儀。八訂は重量目安を収載していない）"
    },
    {
      "id": "13035",
      "label": "クリームチーズ",
