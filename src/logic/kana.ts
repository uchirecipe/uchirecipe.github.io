 ...
 */
const TAG_SYNONYM_GROUPS: readonly (readonly string[])[] = [
  // 2026-08-20 便IL・⑤（オーナー承認）: タグ名は「おやつ」のままで、「デザート」でも当たるように。
  // オーナーの言葉「大学芋がデザートかといえば違う気がするので『おやつ』だよなあ、はあります」
  // 2026-08-21 オーナー追加承認: 「スイーツ」も同じ組へ（検索して0品だった）
  ['おやつ', 'デザート', 'スイーツ'],
  // 2026-08-21 オーナー追加承認: 「常備菜」で0品だった（「作り置き」は44品）
  ['作り置き', '常備菜'],
  // 2026-08-21 オーナー追加承認（原文「スープ↔️汁物も、味噌汁ふくめてOK」）。
  // 2026-08-15 に一度見送った組だが、「スープ」で味噌汁・豚汁が並ぶことをオーナーが了承した
  ['汁物', 'スープ'],
]
