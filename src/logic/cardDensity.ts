 ...
 *   small    … 小さい絵（押せる大きさ44pxの正方形）＋料理名1行。
 *              週の枠・月の日の窓のように、1行ぶんの高さしか無い場所のための形。
 *              高さの下限はアプリ共通の押せる大きさ（--tap-min＝44px）。
 *              2026-08-20 便IG・⑫まで「入れ物が正方形なら絵が全面に広がり、名前は出ない」と
 *              書いてあったが、実際には入れ物の形と関係なく**写真の元の大きさ**で膨らんでいた
 *              （理由と直し方は components/RecipeCard の「小」の節）。
 *
