...
export const ja = {
  ...
  mealPlan: {
    ...
    rangeIntakeNutritionCountBoth: '作った記録{a}品と登録した献立{p}品を、1食ずつ足した概算です',
    rangeIntakeNutritionCountActual: '作った記録{a}品を、1食ずつ足した概算です',
    rangeIntakeNutritionCountPlan: '登録した献立{p}品を、1食ずつ足した概算です',
    ...
    monthSummaryEstimateNote: '食材の目安価格や食品成分表をもとに自動計算した概算です',
    ...
    weekCostNote: '食材の目安価格で自動計算しています。自分の価格に書き換えると、もっと正確になります',
  ...
  nutrition: {
    ...
    // 2026-08-01 線引きB': 折りたたんだ1行に出すのはエネルギーだけ（塩分はPro側の8項目表へ）
    ...
    gramUnit: 'g',
    mgUnit: 'mg',
    estimateNote: '※ 材料と分量から自動計算した概算です。調理による変化などは反映しておらず、実際の栄養価とは異なります。',
