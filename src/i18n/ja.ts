...
export const ja = {
  ...
  mealPlan: {
    ...
    copyLastWeekConfirm: '先週の献立を、空いている枠に{n}件コピーします。今ある献立は上書きされず、そのまま残ります。よろしいですか？',
    copyLastWeekDone: '先週の献立を{n}件コピーしました',
    copyLastWeekNoSource: '先週にはコピーできる献立がありません',
    copyLastWeekNoRoom: '空いている枠がないため、コピーしませんでした（今ある献立はそのまま残っています）',
    ...
    planMismatchDescription: '下の品は「今日の献立」にだけあります。時間帯を押すと、その品を今週の予定（主菜）に登録します。今日の献立は変わりません',
