...
export const ja = {
  ...
  mealPlan: {
    ...
    clearWeekSlotTitle: 'この食事の予定をまとめて消す',
    ...
    templateSaveDescription:
      '表示中の週の献立を曜日ごと覚えます。あとで別の週や月にまとめて入れられます。名前を付けていくつでも保存でき、流し込むときに選べます',
  ...
  nutritionBalance: {
    ...
    dayTitlePlan: 'この日の献立（1人分）',
    dayTitleActual: 'この日の作った記録（1人分）',
    weekTitle: 'この週の献立（1人分）',
